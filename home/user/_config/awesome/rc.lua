...
--]]
awful.util.myapplicationsmenu = freedesktop.menu.build({
    icon_size = beautiful.menu_height or dpi(16),
    before = { },
    after = { }
})
...
awful.key({ modkey,           }, "z", function () awful.util.myapplicationsmenu:show() end,
{description = "show applications menu", group = "awesome"}),
